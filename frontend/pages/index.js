  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Enterprise-grade YouTube channel management and analytics platform"
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-12 text-gray-300 max-w-3xl mx-auto">
            Professional YouTube analytics, content management, and growth automation platform for
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center mb-20">
            <Link
              href="/register"
              className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition transform hover:scale-105"
            >
              Start Free Trial
            </Link>
            <Link
              href="/demo"
              className="border border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white px-8 py-4 rounded-lg text-lg font-semibold transition"
            >
              Watch Demo
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            ...
            >
              ...
              <p className="text-gray-300">
                Real-time performance metrics, audience insights, and growth tracking across all
                your channels
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-6 py-20 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8">
              Join thousands of creators using YTEmpire to grow their channels
            </p>
            <Link
              href="/register"
              className="bg-white text-purple-600 hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-semibold transition inline-block"
            >
